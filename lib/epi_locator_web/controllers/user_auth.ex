defmodule EpiLocatorWeb.UserAuth do
  @moduledoc false
  ...
  # Make the remember me cookie valid for 1 day.
  ...
  def fetch_current_user(conn, _opts) do
    ...
    user_id = user_token && Accounts.get_user_id_by_session_token(user_token)
  ...
  defp maybe_store_return_to(%{method: "GET", request_path: request_path} = conn) do
    user_return_to = request_path <> "?" <> URI.encode_query(Plug.Conn.fetch_query_params(conn).query_params)
    put_session(conn, :user_return_to, user_return_to)
  end

  defp maybe_store_return_to(conn), do: conn

  # Seems like there should be a better way than hard-wiring this path here:
  defp signed_in_path(conn), do: Routes.search_path(conn, :search, Plug.Conn.fetch_query_params(conn).query_params)
end
